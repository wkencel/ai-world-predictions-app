...
from ..freshRSS.entertainmentLinks import extract_entertainment_links
from ..models.entertainmentModel import EntertainmentArticleExtraction
from ..utils.jsonOutputParser import save_json_pretty

# Get fresh links from RSS feed
entertainment_links = extract_entertainment_links()
print('entertainment_links: ', entertainment_links)
print('total entertainment_links: ', len(entertainment_links))
...
# if len(entertainment_links) > 60:
for link in entertainment_links[:2]: # adjust this to scrape more links
    ...
    for item in crawled_data["data"]:
        completion = client.beta.chat.completions.parse(
            ...
            response_format=EntertainmentArticleExtraction,
        )

        entertainment_data_json = completion.choices[0].message.parsed
        save_json_pretty(entertainment_data_json, "entertainment_data.json")

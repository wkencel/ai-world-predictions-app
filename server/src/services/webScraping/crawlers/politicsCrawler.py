...
from ..freshRSS.politicsLinks import extract_politics_links
from ..models.politicsModel import PoliticsArticleExtraction
from ..utils.jsonOutputParser import save_json_pretty

# Get fresh links from RSS feed
politics_links = extract_politics_links()
print('politics_links: ', politics_links)
print('total politics_links: ', len(politics_links))
...
for link in politics_links[:2]: # adjust this to scrape more links
    ...
    for item in crawled_data["data"]:
        completion = client.beta.chat.completions.parse(
            ...
            response_format=PoliticsArticleExtraction,
        )

        politics_data_json = completion.choices[0].message.parsed
        save_json_pretty(politics_data_json, "politics_data.json")

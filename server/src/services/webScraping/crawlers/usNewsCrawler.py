...
print('us_news_links: ', us_news_links)
print('total us_news_links: ', len(us_news_links))
...
for link in us_news_links[:2]: # adjust this to scrape more links
    ...
    for item in crawled_data["data"]:
        ...
        completion = client.beta.chat.completions.parse(
            ...
            response_format=UsNewsArticleExtraction,
        )

        us_news_data_json = completion.choices[0].message.parsed
        save_json_pretty(us_news_data_json, "us_news_data.json")

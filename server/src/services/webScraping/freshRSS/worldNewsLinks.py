...
def extract_world_news_links():
    """
    Fetches and parses the World News RSS feed to extract unique links.
...
if __name__ == "__main__":
    ...
    print(f"Found {len(world_news_links)} links:")
    for link in world_news_links:
        print(link)